...
<div class="form-group row">
    <div class="col-sm-3">
        ...
        <div class="col-sm-2"><label class="switch switch-success"><input type="checkbox" name="head_add_active"><span></span></label></div>
        <label class="col-12 form-control-label">Отключить глобальную вставку</label>
        <div class="col-sm-2"><label class="switch switch-success"><input type="checkbox" name="head_noadd_glob"><span></span></label></div>
    </div>
    <div class="col-sm-9">
...
<div class="form-group row">
    <div class="col-sm-3">
        ...
        <label class="col-12 form-control-label">Включить локальную вставку</label>
        <div class="col-sm-2"><label class="switch switch-success"><input type="checkbox" name="body_add_active"><span></span></label></div>
        <label class="col-12 form-control-label">Отключить глобальную вставку</label>
        <div class="col-sm-2"><label class="switch switch-success"><input type="checkbox" name="body_noadd_glob"><span></span></label></div>
    </div>
    <div class="col-sm-9">
