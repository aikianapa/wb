                    ...
                    <div class="tab-content  p-a m-b-md">
                        ...
                        <div id="pageDescr" class="tab-pane fade show active" role="tabpanel">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="footer" placeholder="Подвал">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label">Заголовок окна</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" placeholder="Заголовок окна браузера">
                                </div>
                            </div>
                            <div class="form-group row">
