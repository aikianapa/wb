...
<ul class="nav nav-tabs" role="tablist">
	<li class="nav-item"><a class="nav-link active" href="#{{_GET[form]}}Descr" data-toggle="tab">{{_LANG[content]}}</a></li>
	<li class="nav-item"><a class="nav-link" href="#{{_GET[form]}}Images" data-toggle="tab">{{_LANG[images]}}</a></li>
    <li class="nav-item"><a class="nav-link" href="#{{_GET[form]}}Seo" data-toggle="tab">{{_LANG[seo]}}</a></li>
</ul>
</div>
