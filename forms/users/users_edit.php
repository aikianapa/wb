                ...
                <form id="{{_GET[form]}}EditForm" data-wb-form="{{_GET[form]}}" data-wb-item="{{id}}" class="form-horizontal" role="form">
                    <div class="form-group row">
                        ...
                        <div class="input-group col-sm-4">
                            ...
                            <div class="input-group-addon btn btn-warning fa fa-key" data-toggle="modal" data-target="#{{_GET[form]}}_{{_GET[mode]}}_pswd" data-wb-allow="admin"></div>
                        </div>
                    ...
                    <div class="tab-content  p-a m-b-md">
                        ...
                        <div id="{{_GET[form]}}Descr" class="tab-pane fade show active" role="tabpanel">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="first_name" placeholder="Имя пользователя">
                                </div>
