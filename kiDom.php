...
//======================================================================//
    ...
    public function tagVariable($Item) {
        ...
        if (!isset($_ENV["variables"])) {
            $_ENV["varriables"]=array();
        }
        $var=$this->attr("var");
        if ($var>"") {
    ...
    public function tagThumbnail($Item=array()) {
        ...
        $form=$this->attr("data-wb-form");
        if ($form=="" && isset($Item["form"])) {
            $form=$Item["form"];
        }
        $from=$this->attr("data-wb-from");
        if ($from=="") {
            $from="images";
        }
        $item=$this->attr("data-wb-item");
        ...
        if (is_numeric($this->attr("src"))) {
            $idx=$this->attr("src");
            $this->removeAttr("src");
            $num=true;
        }
        else {
            $idx=$this->parents("[idx]")->attr("idx");
            if ($idx>"" && $src=="") {
                $num=true;
            }
            else {
        ...
        if ($this->attr("data-wb-size")>"") {
            $size=$this->attr("data-wb-size");
        }
