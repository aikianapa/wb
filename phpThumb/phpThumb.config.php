...
$PHPTHUMB_CONFIG['cache_directory'] = $PHPTHUMB_CONFIG['document_root'].'/uploads/_cache/'; // set the cache directory to an absolute directory for all source images
...
$PHPTHUMB_CONFIG['cache_source_filemtime_ignore_remote'] = false;  // if true, remote source images will not be checked for modification date and cached image will be used if available, even if source image is changed or removed. WARNING: cached performance MUCH slower if this is set to false.
